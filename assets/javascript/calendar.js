...
$(document).ready( function () {
  ...
  $("#calendar_new").click( function () { modal_choice (true, activity_modal_title, activity_modal_choices); });
  $("#calendar_print").click( function () { print_screen ($(this)); });

  // Modale #modal_choice
  $("#modal_choice button.close").click( function () { modal_hide ("modal_choice"); });
